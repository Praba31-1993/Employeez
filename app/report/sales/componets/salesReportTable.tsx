            ...
            <div className="row px-0 mb-3">
                <div className="col-8 px-0">
                    <div className="d-flex gap-2 heading2 textheader">
                        <p className="mb-0 dashboardcard fw-bold p-2 rounded" style={{color:"#f99f2feb"}}>
                            Total Employee :{" "}
                            <span style={{ color: "#8C57FF", fontWeight: 600 }}>
                                {salesData?.length.toString().padStart(2, "0")}
                            </span>
                        </p>
                        <p className="mb-0 dashboardcard fw-bold p-2 rounded" style={{color:"#23c323"}}>
                            Active Employee :{" "}
                            <span style={{ color: "#8C57FF", fontWeight: 600 }}>
                                {ActiveEmployees?.length.toString().padStart(2, "0")}
                            </span>
                        </p>
                        <p className="mb-0 dashboardcard fw-bold p-2 rounded" style={{color:"#f92e2eba"}}>
                            Inactive Employee :{" "}
                            <span style={{ color: "#8C57FF", fontWeight: 600 }}>
