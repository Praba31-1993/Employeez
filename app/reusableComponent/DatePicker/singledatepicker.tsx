...
export default function SingleDatePicker({ startDate, endDate }: any) {
    ...
    return (
        <div style={{ position: "relative" }}>
            ...
            <p className="mb-0 textheader cursorpointer" onClick={toggleCardVisibility}>
            ...
            {showCard && (
                <div className="dashboardcard p-3" style={{ position: "absolute", top: "30px", left: "0", zIndex: "1" }}>
                    ...
                    <div className="d-flex justify-content-end py-3" onClick={() => setShowCard(false)}>
                        <div className="rounded" style={{ border: `1px solid ${useColors.themeRed}`, width: "fit-content" }}>
                            <FilterAltOutlinedIcon className=" m-1" sx={{ color: useColors.themeRed }} />
                        </div>
                    </div>
                </div>
            )}
