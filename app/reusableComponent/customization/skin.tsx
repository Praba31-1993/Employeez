...
export function Skincustomization() {
    ...
    return (
        <div className="col-12 mt-2">
            ...
            <div className="d-flex ps-1 mt-2 align-items-center skin" style={{ gap: "10px" }}>
                {/* Default Style */}
                <div onClick={() => handleSelectStyle("0px", "0px 2px 4px 0px rgba(0, 0, 0, 0.05)")}>
                    <Image
                        src={Default}
                        alt="Default"
                    ...
                    />
                    <p className="mb-0 py-1 shade" style={{ fontSize: "10px" }}>Default</p>
                </div>
                ...
                <div onClick={() => handleSelectStyle("0.5px solid #CCC", "unset")}>
                    <Image
                        src={Border}
                        alt="Border"
                        className={`skin-option ${selectedborder === "0.5px solid #CCC" ? "active" : ""}`}
                        style={{
                            transition: "border 0.3s ease",
                            border: selectedborder === "0.5px solid #CCC" ? `2px solid ${useColors.themeRed}` : " 2px solid transparent",
                        }}
                    />
                    <p className="mb-0 py-1 shade" style={{ fontSize: "10px" }}>Border</p>
                </div>
            </div>
        </div>
    );
