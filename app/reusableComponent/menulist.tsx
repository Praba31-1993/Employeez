            ...
            {loading ? (
                <>
                    ...
                    <div className="roles ps-2">
                        ...
                        <p className="mb-0 cursorPointer para pe-3 d-sm-none d-block" style={{ color: useColors.themeRed }}>
                            <Skeleton height={16} width={80} className="mb-1 ms-2" />
                        </p>
                    </div>
                </>
                ...
                <>
                    ...
                    <div className="userimages">
                        <ImageComponent width={50} height={50} user={"/assets/img/Ellipse 14.svg"} />
                    </div>
                    <div className="roles ps-2">
                        <h5 className="para textheader mb-0">
                            {userData.Firstname} {userData.Lastname}
                        </h5>
                        <p className="para2 mb-0 mt-1 shade">{userData.Role}</p>
                        <p className="mb-0 cursorPointer para pe-3 d-sm-none d-block" style={{ color: useColors.themeRed }}>
                            Supervisee
                        </p>
                    </div>
