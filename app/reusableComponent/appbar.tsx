...
export default function NavbarComponent() {
    ...
    const renderMobileMenu = (
        ...
        >
            ...
            <MenuItem>
                <select name="" id="">
                    <option value="USA">USA LLC</option>
                    <option value="IND">India Pvt Ltd</option>
                    <option value="MCS">Canada Enterprise</option>
                </select>
            </MenuItem>
                ...
                >
                    <Toolbar>
                        ...
                        <Box  sx={{ display: "flex", alignItems: "center",gap:"3px" }}>
                            ...
                            <select className="dropdowncolor para cursorPointer" style={{ background: "transparent" }} name="" id="">
                                <option value="USA">USA LLC</option>
                                <option value="IND">India Pvt Ltd</option>
                                <option value="MCS">Canada Enterprise</option>
                            </select>
