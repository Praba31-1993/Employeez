...
import { faCirclePlus, faFileCircleExclamation } from '@fortawesome/free-solid-svg-icons';
  ...
  { id: 8, expenses: 'Phone'},
    ...
    return (
        <>
            ...
            {openpopups && <Summarydetails showpop={openpopups} close={() => openPopUp(false)} />}
            ...
            <div className="  d-flex align-items-center justify-content-between mt-3">
                ...
                <div className=" d-flex align-items-center justify-content-end">
                    ...
                    <button className="outlinebtn ms-4 px-3 py-1" style={{color:useColors.themeRed,border:`1px solid ${useColors.themeRed}`}} onClick={() => setOpen(prev => !prev)} >
            ...
            <div className="row mt-2">
                ...
                <div className="col-12 d-flex  justify-content-end mt-4">
                    ...
                    <div className="ms-3">
                        <Outlinebutton color={useColors.themeRed }  border={`1px solid ${useColors.themeRed}`}  text="Save" fontSize="12px" background="transparent" />
                    </div>
                    <div className="ms-3">
                        <Outlinebutton color="#FFF" border={`1px solid ${useColors.themeRed}`} text="Submit" fontSize="12px" background={useColors.themeRed } />
                    </div>
                </div>
            </div></>
    )
