...
const ImageComponent = dynamic(() => import("../reusableComponent/image"), { ssr: false });
    ...
    <section className="login">
      <div className="container-fluid px-0 d-flex align-items-center justify-content-center h-100">
        <div className="row h-100 w-100">
          <div className="col-md-6 d-sm-flex d-none p-0 align-items-center flex-column h-100 justify-content-center" style={{ background: useColors.themeRed }}>
            <h1 className="heading fw-bold text-center py-3 text-white">HR on Cloud</h1>
            {/* ✅ Dynamically Loaded Lottie Animation */}
          ...
          <div className="col-sm-6 align-items-center d-flex">
            <div className="logincard ps-md-5 ms-md-5">
              ...
              <div className="form_filed">
                <input className="ps-3 py-2 mt-2" type="password" placeholder="New password" value={newPassword} onChange={handleNewPasswordChange} />
                <input className="ps-3 py-2 mt-3" type="password" placeholder="Confirm password" value={confirmPassword} onChange={handleConfirmPasswordChange} />
                {error && <p className="text-danger mt-2" style={{ fontSize: "0.9rem" }}>{error}</p>}
                <button className="mutlicolourbtn mt-2 py-1 text-center" onClick={handleSubmit} disabled={true} style={{ width: "100%", background: useColors.themeRed }}>
                  Reset password
                </button>
              </div>
